...
__DEFINE__(1598860431294, function(require, module, exports) {
// 引入全局mixin
...
}, function(modId) {var map = {"./libs/mixin/mixin.js":1598860431295,"./libs/request":1598860431296,"./libs/function/queryParams.js":1598860431300,"./libs/function/route.js":1598860431301,"./libs/function/timeFormat.js":1598860431302,"./libs/function/timeFrom.js":1598860431303,"./libs/function/colorGradient.js":1598860431304,"./libs/function/guid.js":1598860431305,"./libs/function/color.js":1598860431306,"./libs/function/type2icon.js":1598860431307,"./libs/function/randomArray.js":1598860431308,"./libs/function/deepClone.js":1598860431298,"./libs/function/deepMerge.js":1598860431297,"./libs/function/addUnit.js":1598860431309,"./libs/function/test.js":1598860431299,"./libs/function/random.js":1598860431310,"./libs/function/trim.js":1598860431311,"./libs/function/toast.js":1598860431312,"./libs/function/getParent.js":1598860431313,"./libs/function/$parent.js":1598860431314,"./libs/function/sys.js":1598860431315,"./libs/function/debounce.js":1598860431316,"./libs/function/throttle.js":1598860431317,"./libs/config/config.js":1598860431318,"./libs/config/zIndex.js":1598860431319}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431295, function(require, module, exports) {
module.exports = {
	data() {
		return {}
	},
...
__DEFINE__(1598860431296, function(require, module, exports) {
...
}, function(modId) { var map = {"../function/deepMerge":1598860431297,"../function/test":1598860431299}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431297, function(require, module, exports) {
...
}, function(modId) { var map = {"./deepClone":1598860431298}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431298, function(require, module, exports) {
...
__DEFINE__(1598860431299, function(require, module, exports) {
/**
 * 验证电子邮箱格式
 */
...
__DEFINE__(1598860431300, function(require, module, exports) {
/**
 * 对象转url参数
 * @param {*} data,对象
...
__DEFINE__(1598860431301, function(require, module, exports) {
var __TEMP__ = require('../../libs/function/queryParams.js');var queryParams = __REQUIRE_DEFAULT__(__TEMP__);
/**
 * 路由跳转
...
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.default = route;

}, function(modId) { var map = {"../../libs/function/queryParams.js":1598860431300}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431302, function(require, module, exports) {
...
__DEFINE__(1598860431303, function(require, module, exports) {
var __TEMP__ = require('../../libs/function/timeFormat.js');var timeFormat = __REQUIRE_DEFAULT__(__TEMP__);
...
}, function(modId) { var map = {"../../libs/function/timeFormat.js":1598860431302}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431304, function(require, module, exports) {
/**
 * 求两个颜色之间的渐变值
...
__DEFINE__(1598860431305, function(require, module, exports) {
/**
...
__DEFINE__(1598860431306, function(require, module, exports) {
...
__DEFINE__(1598860431307, function(require, module, exports) {
/**
 * 根据主题type值,获取对应的图标
...
__DEFINE__(1598860431308, function(require, module, exports) {
// 打乱数组
...
__DEFINE__(1598860431309, function(require, module, exports) {
var __TEMP__ = require('./test.js');var validation = __REQUIRE_DEFAULT__(__TEMP__);

// 添加单位，如果有rpx，%，px等单位结尾或者值为auto，直接返回，否则加上rpx单位结尾
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.default = function addUnit(value = 'auto', unit = 'rpx') {
    value = String(value);
	// 用uView内置验证规则中的number判断是否为数值
    return validation.number(value) ? `${value}${unit}` : value;
};
}, function(modId) { var map = {"./test.js":1598860431299}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1598860431310, function(require, module, exports) {
...
__DEFINE__(1598860431311, function(require, module, exports) {
...
__DEFINE__(1598860431312, function(require, module, exports) {
...
__DEFINE__(1598860431313, function(require, module, exports) {
// 获取父组件的参数，因为支付宝小程序不支持provide/inject的写法
// this.$parent在非H5中，可以准确获取到父组件，但是在H5中，需要多次this.$parent.$parent.xxx
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.default = function getParent(name, keys) {
...
__DEFINE__(1598860431314, function(require, module, exports) {
// 获取父组件的参数，因为支付宝小程序不支持provide/inject的写法
// this.$parent在非H5中，可以准确获取到父组件，但是在H5中，需要多次this.$parent.$parent.xxx
// 这里默认值等于undefined有它的含义，因为最顶层元素(组件)的$parent就是undefined，意味着不传name
// 值(默认为undefined)，就是查找最顶层的$parent
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.default = function $parent(name = undefined) {
	let parent = this.$parent;
	// 通过while历遍，这里主要是为了H5需要多层解析的问题
	while (parent) {
		// 父组件
...
__DEFINE__(1598860431315, function(require, module, exports) {
if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.os = function os() {
	return uni.getSystemInfoSync().platform;
};;

if (!exports.__esModule) Object.defineProperty(exports, "__esModule", { value: true });exports.sys = function sys() {
...
__DEFINE__(1598860431316, function(require, module, exports) {
let timeout = null;
...
__DEFINE__(1598860431317, function(require, module, exports) {
let timer, flag;
/**
 * 节流原理：在一定时间内，只能触发一次
 * 
...
__DEFINE__(1598860431318, function(require, module, exports) {
// 此版本发布于2020-08-25
let version = '1.6.5';
...
__DEFINE__(1598860431319, function(require, module, exports) {
...
return __REQUIRE__(1598860431294);
})()
